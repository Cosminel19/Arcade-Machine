...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //rosu
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //albastru
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //mov
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //rosu
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //verde
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //mov
            VertexFormat(glm::vec3(5, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //rosu
            VertexFormat(glm::vec3(5, 0, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //verde
            VertexFormat(glm::vec3(5, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //albastru
            VertexFormat(glm::vec3(0, 0, 5), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //verde
            VertexFormat(glm::vec3(0, 0, 5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //albastru
            VertexFormat(glm::vec3(0, 0, 5), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //mov
        };
    ...
    {
        int radius = 1;
        int nr_triangles = 100;

        vector<VertexFormat> vertices;
        vector<unsigned int> indices;

        vertices.push_back(VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1))); //centrul

        for (int i = 1; i <= nr_triangles; i++) {
            float angle = 2 * 3.1415 * (i - 1) / nr_triangles;
            float x = radius * cos(angle);
            float y = radius * sin(angle);

            vertices.push_back(VertexFormat(glm::vec3(x, y, 0), glm::vec3(0, 0, 1)));
        }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(10, 2, 0), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-4.5f, 2, 0), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(6, 0, 0), glm::vec3(1));

    // DISC
    RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(5, 0, 0), glm::vec3(1));
...
// BONUS: DISC DE CERC
// TETRAEDRU CU FETE COLORATE DIFERIT