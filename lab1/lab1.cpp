...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    glClearColor(red_colour, green_colour, blue_colour, 1);
    ...
    if (index == 0) {
        RenderMesh(meshes["bunny"], glm::vec3(3, 0, 0), glm::vec3(0.05f));
    }
    else if (index == 1) {
